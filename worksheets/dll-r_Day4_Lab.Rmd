...
**Task B:** Working from the code you used to generate one of these scatterplots, change the labels on this plot.

```{r}
# Your code here
```

**Task C:** Working from the code you used to generate one of these scatterplots, create a new scatterplot where you have the color dictated by a quantitative variable in the `msleep` or `msleep2` dataset. Describe any patterns or outliers you see in this plot.
