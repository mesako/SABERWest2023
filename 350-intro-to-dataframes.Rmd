...
We now convert this matrix into a dataframe type. We work with a dataframe instead of just a matrix because dataframes can tolerate different datatypes in the same table. 
...
The `gapminder` dataset is a pre-made dataset that we can play around with.
