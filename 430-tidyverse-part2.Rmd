...
#### Tidying the COVID-19 example datasets

What needs to happen to each of the datasets `df_1`, `df_2`, and `df_3` to make it "tidy data" as desribed in the [Data Science in R excerpt on tidy data](https://garrettgman.github.io/tidying/). Keep in mind the following goals for each dataset. 
...
Let's take this a step further and tie in what we learned about reshaping data with other functions.
