...
```{r}
heatmap(temp.data, labCol = c("brainwt", "bodywt"))
```

```{r}
heatmap(temp.data, scale = "col", labCol = c("brainwt", "bodywt"))
```

```{r}
heatmap(temp.data, scale = "col", labRow = msleep$name, labCol = c("brainwt", "bodywt"))
```
